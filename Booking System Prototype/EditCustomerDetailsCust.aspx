<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditCustomerDetailsCust.aspx.cs" Inherits="AddFilm" %>
...
<body>
     ...
     <div>
        <p style="margin-left: 120px">
            ...
            <br />
            <br />
            <asp:Label ID="LabelPassword" runat="server" Text="Input Password to Confirm Changes:"></asp:Label>
            <br />
            <asp:TextBox class="txtbox" ID="TextBoxPassword" runat="server"></asp:TextBox>
            <br />
            <br />
