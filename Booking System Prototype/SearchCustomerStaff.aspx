<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SearchCustomerStaff.aspx.cs" Inherits="SearchFilms" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Search By:<br />
        ...
        <br />
        <br />
        <asp:Button class="btn" ID="ButtonSearch" runat="server" Text="Search" Width="217px" OnClick="ButtonSearchCustomer_Click"/>
        &nbsp;
