<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustomerDetailsCust.aspx.cs" Inherits="SearchResult" %>
...
<body>
    ...
    <div>
        ...
        <br />
        <asp:Label ID="LabelDetails" runat="server" Font-Size="XX-Large" Text="Customer Details"></asp:Label>
        <br />
        <br />
        <br />
        </p>
...
&nbsp;0789962345</p>
        ...
        <p style="margin-left: 80px">
            ...
            <br />
            <asp:Button class="btn" ID="ButtonEditDetails" runat="server" Text="Edit Details" OnClick="ButtonEditDetails_Click"/>
