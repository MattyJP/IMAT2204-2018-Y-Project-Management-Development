<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CurrentBookingsStaff.aspx.cs" Inherits="SearchResult" %>
<!DOCTYPE html>
...
<body>
    ...
    <div style="margin-left: 80px">
        ...
        <br />
        <br />
        <asp:Button class="btn" ID="ButtonTake" runat="server" Text="Take Ticket" OnClick="ButtonTake_Click"/> 
        <asp:Button class="btn" ID="ButtonHistory" runat="server" Text="See Booking History" OnClick="ButtonHistory_Click"/>
        <br />
        <br />
