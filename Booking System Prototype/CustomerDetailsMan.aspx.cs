...
public partial class SearchResult : System.Web.UI.Page
{
    ...
    {
        //This method redirects the manager to the manager edit-customer-details page
        Response.Redirect("EditCustomerDetailsMan.aspx");
    }
    protected void ButtonBookings_Click(object sender, EventArgs e)
    {
        //This method redirects the manager to the manager current-bookings page
        Response.Redirect("ViewCurrentBookingsMan.aspx");
    }
